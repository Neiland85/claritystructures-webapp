import type { AssuranceEventViewModel } from "./control-room-view-model";

type AssuranceTrailProps = {
  events: AssuranceEventViewModel[];
};

export function AssuranceTrail({ events }: AssuranceTrailProps) {
  return (
