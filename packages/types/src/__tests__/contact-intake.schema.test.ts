...
import { ContactIntakeSchema, UrgencySchema, ClientProfileSchema } from '../validations/contact-intake.schema';
...
describe('Contact Intake Schema', () => {
  describe('ContactIntakeSchema', () => {
    ...
    it('should accept valid urgency levels', () => {
      const urgencies = ['informational', 'time_sensitive', 'legal_risk', 'critical'];
